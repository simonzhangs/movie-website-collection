...
import { getPopularMovies, getPopularTV, getTrending, getImageUrl } from '@/lib/tmdb/client';
          ...
          <div className="relative flex h-full items-end">
            <div className="mx-auto w-full max-w-7xl px-4 pb-12 sm:px-6 lg:px-8">
              <div className="max-w-2xl">
                <span className="mb-3 inline-block rounded-full bg-indigo-500/20 px-3 py-1 text-xs font-medium text-indigo-300">
                  {t('trending')}
                </span>
                <h1 className="mb-3 text-4xl font-bold text-white sm:text-5xl lg:text-6xl">
                  {heroTitle}
                </h1>
                <p className="mb-6 line-clamp-3 text-base text-gray-300 sm:text-lg">
                  {heroOverview}
                </p>
                <Link
                  href={heroHref}
